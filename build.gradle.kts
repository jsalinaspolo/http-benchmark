...
dependencies {
  ...
  implementation("org.eclipse.jetty:jetty-server:12.1.2")
  ...
  implementation("io.ktor:ktor-server-jetty-jakarta:3.3.1")
  ...
  implementation("io.micronaut:micronaut-runtime:4.10.3")
  implementation("io.micronaut:micronaut-http:4.10.3")
  implementation("io.micronaut:micronaut-http-server-netty:4.10.3")
