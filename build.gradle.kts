...
dependencies {
  ...
  implementation("io.micronaut:micronaut-runtime:5.1.11")
  implementation("io.micronaut:micronaut-http:5.1.11")
  implementation("io.micronaut:micronaut-http-server-netty:5.1.11")
