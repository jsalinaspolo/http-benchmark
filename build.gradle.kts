...
dependencies {
  ...
  implementation("io.netty:netty-codec-socks:4.2.9.Final")
  implementation("io.netty:netty-resolver-dns:4.2.9.Final")
  implementation("io.netty:netty-handler-proxy:4.2.9.Final")
  ...
  implementation("io.micronaut:micronaut-runtime:4.10.14")
  implementation("io.micronaut:micronaut-http:4.10.14")
  implementation("io.micronaut:micronaut-http-server-netty:4.10.14")
  implementation("org.openjdk.jmh:jmh-core:1.37")
  implementation("org.openjdk.jmh:jmh-generator-annprocess:1.37")
  implementation("org.apache.httpcomponents:httpclient:4.5.14")
  implementation("com.squareup.okhttp3:okhttp:5.3.2")
  implementation(platform("com.linecorp.armeria:armeria-bom:1.35.0"))
