...
dependencies {
  ...
  implementation("io.micronaut:micronaut-runtime:5.1.10")
  implementation("io.micronaut:micronaut-http:5.1.10")
  implementation("io.micronaut:micronaut-http-server-netty:5.1.10")
  implementation("org.openjdk.jmh:jmh-core:1.37")
  implementation("org.openjdk.jmh:jmh-generator-annprocess:1.37")
  implementation("org.apache.httpcomponents:httpclient:4.5.14")
  implementation("com.squareup.okhttp3:okhttp:5.4.0")
  implementation(platform("com.linecorp.armeria:armeria-bom:1.41.0"))
