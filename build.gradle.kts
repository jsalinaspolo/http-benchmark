...
dependencies {
  ...
  implementation("io.ktor:ktor-server-jetty-jakarta:3.4.1")
  implementation("io.vertx:vertx-web:5.0.8")
  implementation(platform("org.http4k:http4k-bom:6.32.0.0"))
  implementation("org.http4k:http4k-core")
  implementation("org.http4k:http4k-server-netty")
  implementation("org.http4k:http4k-server-jetty")
  implementation("org.http4k:http4k-server-helidon")
  implementation("org.http4k:http4k-server-ratpack")
  implementation("io.micronaut:micronaut-runtime:4.10.17")
  implementation("io.micronaut:micronaut-http:4.10.17")
  implementation("io.micronaut:micronaut-http-server-netty:4.10.17")
