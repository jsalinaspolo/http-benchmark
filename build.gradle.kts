...
dependencies {
  ...
  implementation("io.ktor:ktor-server-jetty-jakarta:3.6.0")
  ...
  implementation("io.micronaut:micronaut-runtime:4.10.23")
  implementation("io.micronaut:micronaut-http:4.10.23")
