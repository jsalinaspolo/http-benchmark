...
dependencies {
  ...
  implementation("io.micronaut:micronaut-runtime:4.9.5")
  implementation("io.micronaut:micronaut-http:4.9.5")
  implementation("io.micronaut:micronaut-http-server-netty:4.9.5")
