...
dependencies {
  ...
  implementation("io.netty:netty-codec-socks:4.2.6.Final")
  implementation("io.netty:netty-resolver-dns:4.2.6.Final")
  implementation("io.netty:netty-handler-proxy:4.2.6.Final")
  implementation("io.ratpack:ratpack-core:1.9.0")
  implementation("com.fasterxml.jackson.core:jackson-annotations:2.20")
  implementation("io.ktor:ktor-server-netty:3.3.0")
  implementation("io.ktor:ktor-server-jetty-jakarta:3.3.0")
  ...
  implementation("io.micronaut:micronaut-runtime:4.9.11")
  implementation("io.micronaut:micronaut-http:4.9.11")
  implementation("io.micronaut:micronaut-http-server-netty:4.9.11")
  implementation("org.openjdk.jmh:jmh-core:1.37")
  implementation("org.openjdk.jmh:jmh-generator-annprocess:1.37")
  implementation("org.apache.httpcomponents:httpclient:4.5.14")
  implementation("com.squareup.okhttp3:okhttp:5.1.0")
  implementation(platform("com.linecorp.armeria:armeria-bom:1.33.2"))
