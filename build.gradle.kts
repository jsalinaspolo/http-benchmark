...
dependencies {
  ...
  implementation("io.micronaut:micronaut-runtime:4.9.8")
  implementation("io.micronaut:micronaut-http:4.9.8")
  implementation("io.micronaut:micronaut-http-server-netty:4.9.8")
