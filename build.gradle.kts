...
dependencies {
  ...
  implementation(platform("org.http4k:http4k-bom:6.35.0.0"))
  implementation("org.http4k:http4k-core")
  implementation("org.http4k:http4k-server-netty")
  implementation("org.http4k:http4k-server-jetty")
  implementation("org.http4k:http4k-server-helidon")
  implementation("org.http4k:http4k-server-ratpack")
  implementation("io.micronaut:micronaut-runtime:4.10.18")
  implementation("io.micronaut:micronaut-http:4.10.18")
