...
dependencies {
  ...
  implementation("io.micronaut:micronaut-runtime:4.10.7")
  implementation("io.micronaut:micronaut-http:4.10.7")
  implementation("io.micronaut:micronaut-http-server-netty:4.10.7")
