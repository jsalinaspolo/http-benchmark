...
dependencies {
  ...
  implementation("io.netty:netty-buffer:4.2.18.Final")
  implementation("io.netty:netty-codec-socks:4.2.18.Final")
  ...
  implementation("io.micronaut:micronaut-runtime:5.2.0")
  implementation("io.micronaut:micronaut-http:5.2.0")
  implementation("io.micronaut:micronaut-http-server-netty:5.2.0")
  implementation("org.openjdk.jmh:jmh-core:1.37")
  implementation("org.openjdk.jmh:jmh-generator-annprocess:1.37")
  implementation("org.apache.httpcomponents:httpclient:4.5.14")
  implementation("com.squareup.okhttp3:okhttp:5.5.0")
  implementation(platform("com.linecorp.armeria:armeria-bom:1.41.1"))
