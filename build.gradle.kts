...
dependencies {
  ...
  implementation("io.micronaut:micronaut-runtime:5.2.2")
  implementation("io.micronaut:micronaut-http:5.2.2")
  implementation("io.micronaut:micronaut-http-server-netty:5.2.2")
