...
dependencies {
  ...
  implementation("io.ktor:ktor-server-jetty-jakarta:3.4.2")
  implementation("io.vertx:vertx-web:5.0.10")
  implementation(platform("org.http4k:http4k-bom:6.42.0.0"))
  implementation("org.http4k:http4k-core")
  implementation("org.http4k:http4k-server-netty")
  implementation("org.http4k:http4k-server-jetty")
  implementation("org.http4k:http4k-server-helidon")
  implementation("org.http4k:http4k-server-ratpack")
  implementation("io.micronaut:micronaut-runtime:4.10.20")
  implementation("io.micronaut:micronaut-http:4.10.20")
  implementation("io.micronaut:micronaut-http-server-netty:4.10.20")
  implementation("org.openjdk.jmh:jmh-core:1.37")
  implementation("org.openjdk.jmh:jmh-generator-annprocess:1.37")
  implementation("org.apache.httpcomponents:httpclient:4.5.14")
  implementation("com.squareup.okhttp3:okhttp:5.3.2")
  implementation(platform("com.linecorp.armeria:armeria-bom:1.37.0"))
