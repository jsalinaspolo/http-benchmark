...
dependencies {
  ...
  implementation("io.netty:netty-buffer:4.2.3.Final")
  implementation("io.netty:netty-codec-socks:4.2.3.Final")
  implementation("io.netty:netty-resolver-dns:4.2.3.Final")
  implementation("io.netty:netty-handler-proxy:4.2.3.Final")
  ...
  implementation("io.micronaut:micronaut-runtime:4.9.9")
  implementation("io.micronaut:micronaut-http:4.9.9")
  implementation("io.micronaut:micronaut-http-server-netty:4.9.9")
