...
dependencies {
  ...
  implementation("io.micronaut:micronaut-runtime:5.0.1")
  implementation("io.micronaut:micronaut-http:5.0.1")
  implementation("io.micronaut:micronaut-http-server-netty:5.0.1")
