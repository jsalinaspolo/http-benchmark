...
dependencies {
  ...
  implementation("io.ktor:ktor-server-jetty-jakarta:3.3.2")
  ...
  implementation("io.micronaut:micronaut-runtime:4.10.9")
  implementation("io.micronaut:micronaut-http:4.10.9")
  implementation("io.micronaut:micronaut-http-server-netty:4.10.9")
  implementation("org.openjdk.jmh:jmh-core:1.37")
  implementation("org.openjdk.jmh:jmh-generator-annprocess:1.37")
  implementation("org.apache.httpcomponents:httpclient:4.5.14")
  implementation("com.squareup.okhttp3:okhttp:5.3.2")
  implementation(platform("com.linecorp.armeria:armeria-bom:1.34.0"))
